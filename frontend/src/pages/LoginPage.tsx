...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      login(token, { id, name, email: userEmail });
      ...
      <div className="w-full max-w-md z-10">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-black tracking-tight text-slate-900 dark:text-white mb-2">
            Sign in to <span className="gradient-text">FlowBoard</span>
          </h1>
          <p className="text-slate-500 dark:text-slate-400 font-medium">
            Let's get you set up with your premium workspace
          </p>
        </div>
        ...
        <div className="glass-panel p-8 rounded-3xl premium-glow">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-11 pr-4 py-3.5 rounded-2xl border text-sm font-medium transition-all outline-none bg-slate-50/50 dark:bg-[#1e293b]/30 ${
                    errors.email
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex items-center justify-center gap-2 py-4 rounded-2xl bg-brand-600 hover:bg-brand-500 disabled:bg-brand-400 text-white font-bold transition-all shadow-premium hover:shadow-premium-hover relative overflow-hidden group"
            >
              {loading ? (
